...
const floorColorTexture = textureLoader.load(
  "./floor/leafy_grass_1k/leafy_grass_diff_1k.jpg"
);
const floorARMTexture = textureLoader.load(
  "./floor/leafy_grass_1k/leafy_grass_arm_1k.jpg"
);
const floorNormalTexture = textureLoader.load(
  "./floor/leafy_grass_1k/leafy_grass_nor_gl_1k.jpg"
);
const floorDisplacementTexture = textureLoader.load(
  "./floor/leafy_grass_1k/leafy_grass_disp_1k.jpg"
);
...
const wallColorTexture = textureLoader.load(
  "./wall/wall_bricks_plaster_1k/wall_bricks_plaster_diff_1k.jpg"
);
const wallARMTexture = textureLoader.load(
  "./wall/wall_bricks_plaster_1k/wall_bricks_plaster_arm_1k.jpg"
);
const wallBumpTexture = textureLoader.load(
  "./wall/wall_bricks_plaster_1k/wall_bricks_plaster_bump_1k.jpg"
);
const wallNormalTexture = textureLoader.load(
  "./wall/wall_bricks_plaster_1k/wall_bricks_plaster_nor_gl_1k.jpg"
);
...
wallBumpTexture.repeat.set(2, 2);
wallNormalTexture.repeat.set(2, 2);

wallColorTexture.wrapS = THREE.RepeatWrapping;
wallARMTexture.wrapS = THREE.RepeatWrapping;
wallBumpTexture.wrapS = THREE.RepeatWrapping;
wallNormalTexture.wrapS = THREE.RepeatWrapping;

wallColorTexture.wrapT = THREE.RepeatWrapping;
wallARMTexture.wrapT = THREE.RepeatWrapping;
wallBumpTexture.wrapT = THREE.RepeatWrapping;
wallNormalTexture.wrapT = THREE.RepeatWrapping;

// Roof
const roofColorTexture = textureLoader.load(
  "./roof/worn_corrugated_iron_1k/worn_corrugated_iron_diff_1k.jpg"
);
const roofARMTexture = textureLoader.load(
  "./roof/worn_corrugated_iron_1k/worn_corrugated_iron_arm_1k.jpg"
);
const roofNormalTexture = textureLoader.load(
  "./roof/worn_corrugated_iron_1k/worn_corrugated_iron_nor_gl_1k.jpg"
);

roofColorTexture.colorSpace = THREE.SRGBColorSpace;

roofColorTexture.repeat.set(8, 3);
roofARMTexture.repeat.set(8, 3);
